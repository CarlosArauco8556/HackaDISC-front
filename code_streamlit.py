...
if seccion == "🏢 Clientes/Empresas":
    ...
    try:
        url_general = f"https://web-production-34b5a.up.railway.app/comercializaciones/tiempo_pago_promedio"
    ...
    if nombre_cliente and (buscar_btn or nombre_cliente):
        try:
            ...
            url_info_cliente = f"https://web-production-34b5a.up.railway.app/clientes/tiempo_pago_promedio/{nombre_cliente}"
            url_etapas_cliente = f"https://web-production-34b5a.up.railway.app/clientes/tiempos_etapa/{nombre_cliente}"
            ...
            if response_info_cliente.status_code == 200 and response_etapas_cliente.status_code == 200:
                ...
                with st.container():
                    ...
                    if predict_btn:
                        try:
                            url_pred = f"https://web-production-34b5a.up.railway.app/clientes/predict_cliente?cliente_id={cliente_id}&valor_venta={valor_venta}"
...
# --- Sección: Líderes Comerciales ---
    ...
    if correo_lider and (buscar_lider_btn or correo_lider):
        try:
            url_lideres_comerciales = f"https://web-production-34b5a.up.railway.app/clientes/tiempos_etapa_lider/{correo_lider}"
...
# --- Sección: Destacados ---
    ...
    try:
        url_destacados = f"https://web-production-34b5a.up.railway.app/comercializaciones/destacados"
